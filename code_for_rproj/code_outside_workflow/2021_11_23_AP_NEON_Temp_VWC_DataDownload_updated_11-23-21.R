...
saveRDS(temp_winter1, file = "/path/temp_winter1.RData")
saveRDS(temp_spring1, file = "/path/temp_spring1.RData")
saveRDS(temp_summer1, file = "/path/temp_summer1.RData")
saveRDS(temp_fall1, file = "ap_download/temp_fall1.RData")
saveRDS(temp_winter2, file = "/path/temp_winter2.RData")
saveRDS(temp_spring2, file = "/path/temp_spring2.RData")
saveRDS(temp_summer2, file = "/path/temp_summer2.RData")
saveRDS(temp_fall2, file = "/path/temp_fall2.RData")

saveRDS(moisture_winter1, file = "/path/moisture_winter1.RData")
saveRDS(moisture_spring1, file = "/path/moisture_spring1.RData")
saveRDS(moisture_summer1, file = "/path/moisture_summer1.RData")
saveRDS(moisture_fall1, file = "ap_download/moisture_fall1.RData")
saveRDS(moisture_winter2, file = "/path/moisture_winter2.RData")
saveRDS(moisture_spring2, file = "/path/moisture_spring2.RData")
saveRDS(moisture_summer2, file = "/path/moisture_summer2.RData")
